 ...
 * ordinary failures.
 *
 * The behaviour lives in utils/guard, which owns both the session check and the
 * redirect; this is the identity module's name for it.
 */
const handleAuthFailure = guard.endSessionOnAuthFailure;
